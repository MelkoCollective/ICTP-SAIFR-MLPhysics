...
def train(args):
    ...
    trainName = 'data_ising2d/datasets/ising2d_L'+str(args.L)+'_T'+str(T)+'_train.txt'
    testName = 'data_ising2d/datasets/ising2d_L'+str(args.L)+'_T'+str(T)+'_test.txt'
    ...
    # Build lattice
    path_to_lattice = 'data_ising2d/lattice2d_L'+str(args.L)+'.txt'
...
def sample(args):
    ...
    path_to_params = 'data_ising2d/parameters/parameters_nH'+str(num_hidden) + '_L'+str(args.L)+'_T'+str(T)+'.npz'
